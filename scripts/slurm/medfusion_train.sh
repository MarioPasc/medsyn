#!/bin/bash
#SBATCH -J medfusion_train
#SBATCH --time=48:00:00
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=8
#SBATCH --mem=64G
#SBATCH --gres=gpu:1
#SBATCH --output=logs/medfusion_%j.out
#SBATCH --error=logs/medfusion_%j.err

# MedFusion Training Script for SLURM Cluster
#
# Usage:
#   sbatch scripts/slurm/medfusion_train.sh pathmnist
#   sbatch scripts/slurm/medfusion_train.sh bloodmnist
#   sbatch scripts/slurm/medfusion_train.sh dermamnist
#
# Environment setup:
...
# Run training
echo "Starting MedFusion training for $DATASET..."
medfusion-train config/adapters/medfusion_${DATASET}.yaml
