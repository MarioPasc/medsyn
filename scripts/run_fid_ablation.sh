...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    ...
    --model temp05 "$SAMPLES_DIR/not_considering_minSNR/temp05_inference/train/temp05_inference.npz" \
...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    --ground-truth $GT_PATH \
    --model temp10 "$SAMPLES_DIR/not_considering_minSNR/temp10_inference/train/temp10_inference.npz" \
...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    --ground-truth $GT_PATH \
    --model temp15 "$SAMPLES_DIR/not_considering_minSNR/temp15_inference/train/temp15_inference.npz" \
...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    --ground-truth $GT_PATH \
    --model temp20 "$SAMPLES_DIR/not_considering_minSNR/temp20_inference/train/temp20_inference.npz" \
...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    --ground-truth $GT_PATH \
    --model temp25 "$SAMPLES_DIR/not_considering_minSNR/temp25_inference/train/temp25_inference.npz" \
...
python medsyn/analysis/ddpm_performance/metrics/fid.py \
    --ground-truth $GT_PATH \
    --model temp30 "$SAMPLES_DIR/not_considering_minSNR/temp30_inference/train/temp30_inference.npz" \
