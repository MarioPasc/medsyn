# medsyn/cli/generate_cbdm.py
"""
CLI for generating synthetic images with trained CBDM models.

Usage:
    cbdm-generate config/adapters/cbdm_pathmnist.yaml --num-samples 1000
    cbdm-generate config/adapters/cbdm_pathmnist.yaml --augment original.npz --output augmented.npz
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Generate synthetic images with trained CBDM"
    )
    parser.add_argument(
        "config",
        type=str,
    ...
    from medsyn.adapters.cbdm.generate import generate_and_save, augment_dataset
