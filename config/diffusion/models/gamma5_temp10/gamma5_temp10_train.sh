...
# ---------- Inputs ----------
EXPERIMENT_NAME="gamma5_temp10_training"
...
CONFIG_FILE="experiments/gamma5_temp10/gamma5_temp10.yaml"
CONFIG_BACKUP="experiments/gamma5_temp10/gamma5_temp10.yaml.backup"
