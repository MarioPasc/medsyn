#!/usr/bin/env bash
#SBATCH -J log_exp3_baseline_no_weighting
...
# ---------- Inputs ----------
EXPERIMENT_NAME="exp3_baseline_no_weighting_training"
...
CONFIG_FILE="experiments/ablation_study/exp3_baseline_no_weighting/exp3_baseline_no_weighting.yaml"
CONFIG_BACKUP="experiments/ablation_study/exp3_baseline_no_weighting/exp3_baseline_no_weighting.yaml.backup"
