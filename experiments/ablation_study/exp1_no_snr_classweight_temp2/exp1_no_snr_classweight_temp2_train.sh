#!/usr/bin/env bash
#SBATCH -J log_exp1_no_snr_classweight_temp2
...
# ---------- Inputs ----------
EXPERIMENT_NAME="exp1_no_snr_classweight_temp2_training"
...
CONFIG_FILE="experiments/ablation_study/exp1_no_snr_classweight_temp2/exp1_no_snr_classweight_temp2.yaml"
CONFIG_BACKUP="experiments/ablation_study/exp1_no_snr_classweight_temp2/exp1_no_snr_classweight_temp2.yaml.backup"
