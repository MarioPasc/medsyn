#!/usr/bin/env bash
#SBATCH -J log_exp2_snr_no_classweight
...
# ---------- Inputs ----------
EXPERIMENT_NAME="exp2_snr_no_classweight_training"
...
CONFIG_FILE="experiments/ablation_study/exp2_snr_no_classweight/exp2_snr_no_classweight.yaml"
CONFIG_BACKUP="experiments/ablation_study/exp2_snr_no_classweight/exp2_snr_no_classweight.yaml.backup"
