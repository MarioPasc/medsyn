#!/usr/bin/env bash
#SBATCH -J log_exp3_baseline_no_weighting_infer
...
CHECKPOINT_SRC="/mnt/home/users/tic_163_uma/mpascual/fscratch/results/exp3_baseline_no_weighting_training/ckpts/best.pt"

# Where to store generated images
RESULTS_DST="/mnt/home/users/tic_163_uma/mpascual/fscratch/results/exp3_baseline_no_weighting_inference"
...
CONFIG_TEMP="${REPO_DIR}/experiments/ablation_study/exp3_baseline_no_weighting/exp3_baseline_no_weighting.yaml"
