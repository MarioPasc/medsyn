#!/usr/bin/env bash
#SBATCH -J log_exp2_snr_no_classweight_infer
...
CHECKPOINT_SRC="/mnt/home/users/tic_163_uma/mpascual/fscratch/results/exp2_snr_no_classweight_training/ckpts/best.pt"

# Where to store generated images
RESULTS_DST="/mnt/home/users/tic_163_uma/mpascual/fscratch/results/exp2_snr_no_classweight_inference"
...
CONFIG_TEMP="${REPO_DIR}/experiments/ablation_study/exp2_snr_no_classweight/exp2_snr_no_classweight.yaml"
