#!/usr/bin/env bash
#SBATCH -J log_noMinSNR_ccddpm_parallel
...
# ---------- Inputs ----------
EXPERIMENT_NAME="noMinSNR_ccDDPM_parallel"
...
CONFIG_FILE="experiments/ccDDPM_exp1/noMinSNR.yaml"
CONFIG_BACKUP="experiments/ccDDPM_exp1/noMinSNR.yaml.backup"
