...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp20_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp20/temp20.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp20/temp20.yaml.backup"
