...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp10_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp10/temp10.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp10/temp10.yaml.backup"
