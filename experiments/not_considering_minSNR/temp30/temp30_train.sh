...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp30_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp30/temp30.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp30/temp30.yaml.backup"
