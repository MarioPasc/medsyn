...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp25_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp25/temp25.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp25/temp25.yaml.backup"
