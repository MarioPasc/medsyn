...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp05_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp05/temp05.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp05/temp05.yaml.backup"
