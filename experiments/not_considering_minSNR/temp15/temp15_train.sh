...
# ---------- Inputs ----------
EXPERIMENT_NAME="temp15_training"
...
CONFIG_FILE="experiments/not_considering_minSNR/temp15/temp15.yaml"
CONFIG_BACKUP="experiments/not_considering_minSNR/temp15/temp15.yaml.backup"
